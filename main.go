...
const (
	ListingLatestEndpoint  = "/v1/cryptocurrency/listings/latest"
...
func main() {
	...
	switch *endpoint {
	case ListingLatest:
		URL = "https://" + DOMAIN + CategoriesEndpoint
	case Categories:
		URL = "https://" + DOMAIN + ListingLatestEndpoint
	case Category:
		URL = "https://" + DOMAIN + CategoryEndpoint
	case TrendingLatest:
		URL = "https://" + DOMAIN + TrendingLatestEndpoint
	default:
...
func FilterAITrends(trends *types.Data) []*types.Coin {
